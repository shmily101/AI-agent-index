<template>
  <section
    ...
    gap-100
    min-h-950
    class="bg-[url('~/assets/img/service-s3-bg.png')] bg-cover keep-px-section"
  >
    <div text="48 gray" mb-200>
      ...
      <p>
        ...
        <span
          id="text-type"
          text-primary
          bg="[linear-gradient(transparent_75%,_rgba(42,_130,_228,_0.34)_0%)]"
        >
        </span>
        <span ml-12>解决方案。</span>
      </p>
      <p text="18 #A6A6A6" mt-35 w-685>
        我们提供高度定制化的人工智能解决方案，<br />专注于自然语言处理 (NLP)
        和Prompt Engineering，帮助各类企业和机构快速实现智能化转型。<br />通过灵活的解决方案和全面的技术支持，我们助您应对业务挑战、提升效率，并推动企业持续增长。
      </p>
    </div>
