  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div w-full flex="~ col" items-center justify-center relative z-20>
          <h1
            class="section-agent-gradient section-name"
            font-extrabold
            text-72
            tracking-wider
            mb-14
    ...
    >
      ...
      <img
        ...
        mt-30
        border-rd-30px
        src="~/assets/img/home-s3-01-poster.jpg"
      />
    </section>
...
#section-agent {
  .section-agent-gradient {
    background-image: linear-gradient(
      ...
      rgba(42, 130, 228, 1) 0%,
      rgba(52, 120, 247, 1) 0%,
      rgba(155, 210, 250, 1) 62.87%,
      rgba(245, 255, 250, 1) 100%
    );
    color: transparent;
