...
const advantagesList = [
  {
    title: "快速解决方案",
    content:
      "及时的工程师擅长快速理解和解决项目需求，</br>大大缩短开发周期和产品上市时间。",
    img: "_nuxt/assets/svg/adv-logo1.svg",
  },
  {
    title: "经济高效的解决方案",
    content:
      "聘请一位反应敏捷的工程师可以大幅节省成本。</br>他们高效的工作方式确保资源得到最佳利用，</br>从而降低开发成本。",
    img: "_nuxt/assets/svg/adv-logo2.svg",
  },
  {
    title: "提高生产力",
    content:
      "提示工程师专注于在紧迫的期限内交付高质量的工作，</br>从而提高整个团队的生产力。</br>他们高效而专注的方法确保项目顺利进展。",
    img: "_nuxt/assets/svg/adv-logo3.svg",
  },
  {
    title: "改进的语言生成",
    content:
      "提示工程师可以提高语言生成的质量，</br>使人工智能聊天机器人更易于理解和更像人类。</br>通过聘请及时的工程师，</br>您可以确保创建能够轻松回答具有挑战性的查询的机器人。",
    img: "_nuxt/assets/svg/adv-logo4.svg",
  },
  {
    title: "精密度和准确度",
    content:
      "精度是软件开发的关键，</br>而敏捷的工程师擅长提供准确的结果。</br>他们对细节的细致关注确保最终产品完美地满足要求，</br>从而提高客户满意度。",
    img: "_nuxt/assets/svg/adv-logo5.svg",
  },
  {
    title: "个性化回复",
    content:
      "提示工程师开发了聊天机器人，</br>可根据每位访客的独特需求提供个性化响应。</br>这种定制增强了用户体验，使互动更加个性化和真实。",
